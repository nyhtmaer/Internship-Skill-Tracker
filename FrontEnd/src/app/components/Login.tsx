...
export default function Login() {
  ...
  const handleOAuth = (provider: 'google' | 'github') => {
    // Redirect to backend Passport route — it will redirect to the real Google/GitHub login page
      ...
      <div className="w-full max-w-md bg-card border border-border rounded-xl p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-primary text-primary-foreground font-medium rounded-lg px-4 py-2.5 text-sm hover:bg-primary/90 transition-colors disabled:opacity-50"
          >
